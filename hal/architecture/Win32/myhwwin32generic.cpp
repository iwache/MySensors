...
#include "MyHwWin32Generic.h"

#include <errno.h>
#include <stdarg.h>
#include <stdio.h>
#include <stdlib.h>
// TODO: #iwa #include <syscall.h>
// TODO: #iwa #include <unistd.h>
#include "SoftEeprom.h"
#include "log.h"

static SoftEeprom eeprom = SoftEeprom(MY_WIN32_CONFIG_FILE, 1024);	// ATMega328 has 1024 bytes
...
#ifdef MY_Win32_SERIAL_GROUPNAME
	if (!MY_SERIALDEVICE.setGroupPerm(MY_Win32_SERIAL_GROUPNAME)) {
...
//TODO: #iwa 	while (hwGetentropy(&seed, sizeof(seed)) != sizeof(seed));
	randomSeed(seed);
}

//TODO: #iwa ssize_t hwGetentropy(void *__buffer, size_t __length)
//{
