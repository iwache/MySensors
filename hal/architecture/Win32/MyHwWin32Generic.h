...
#ifndef MyHwWin32Generic_h
#define MyHwWin32Generic_h
...
#ifdef MY_Win32_IS_SERIAL_PTY
SerialPort Serial = SerialPort(MY_Win32_SERIAL_PTY, true);
#else
SerialPort Serial = SerialPort(MY_Win32_SERIAL_PORT);
#endif
#else
...
//TODO: #iwa #define MY_HW_HAS_GETENTROPY
